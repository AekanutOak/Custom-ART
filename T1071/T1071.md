...
##### Description: Command and Control (C2) server established by PathToAtomicsFolder\T1071\bin\telnet_server.exe with given IP must be reachable by client (telnet_client.exe)
